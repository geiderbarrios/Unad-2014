...
a=0;
suma=0;
cout<<"ingrese la cantidad de vendedores que va analizar"<<endl;
cin>>n;
for (a=1;a<=n;a++) {
...
if (nipb<nipa && nipb<nipc && nipb<nipd && nipb<nipe) {
cout<<"el producto menos vendido es el B"<<endl;
} else {
if (nipc<nipa && nipc<nipb && nipc<nipd && nipc<nipe) {
cout<<"el producto menos vendido es el C"<<endl;
} else {
if (nipd<nipa && nipd<nipb && nipd<nipc && nipd<nipe) {
cout<<"el producto menos vendido es el D"<<endl;
} else {
if (nipe<nipa && nipe<nipb && nipe<nipc && nipe<nipd) {
cout<<"el producto menos vendido es el E"<<endl;
}
}
}
}
